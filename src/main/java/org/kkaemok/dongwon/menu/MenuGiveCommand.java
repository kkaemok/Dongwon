...
public final class MenuGiveCommand implements CommandExecutor {
    private final ServerMenuManager serverMenuManager;
    private final ConfigText text;

    public MenuGiveCommand(ServerMenuManager serverMenuManager, ConfigText text) {
    ...
    public boolean onCommand(
        ...
        serverMenuManager.giveCompassIfMissing(player, true);
        return true;
    }
}
